...
class ArduinoService(Service):
    ...
    def init(self):
        ...
        self._loop_delay = self._config.get('loop', 0.1)
    ...
    def before(self):
        ...
        if not is_rpi():
            ...
            try:
                ...
                logging.error(f'Exception opening Arduino serial: {e}')
    ...
    def send(self, data: dict):
        ...
        if self.__send_data is None:
            self.__send_data = {}
        self.__send_data.update(data)
    ...
    def __send(self):
        ...
        if self.__serial is None or not self.__serial.is_open:
            ...
            return
        try:
            json_data = json.dumps(self.__send_data)
    ...
    def __receive(self):
        ...
        if self.__serial.in_waiting > 0:
            ...
            logging.info(f'Received raw line from Arduino: {line}')
            try:
